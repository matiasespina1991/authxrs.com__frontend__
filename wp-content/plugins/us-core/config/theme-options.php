...
return array(
	...
	'layout' => array(
		...
		'fields' => array(
			...
			'row_height' => array(
				'title' => __( 'Row Vertical Indents by default', 'us' ),
				'title_pos' => 'side',
				'type' => 'select',
				'options' => array(
	...
	'advanced' => array(
		...
		'fields' => array(
			...
			'live_builder' => array(
				...
				'description' => US_THEMENAME . ' 8 introduces a new live builder, which allows to edit pages on the frontend. This should save you a lot of time. Try edit pages via green "Edit Live" button.',
				'std' => 1,
				'classes' => 'desc_2',
			),
			...
			'schema_faqs_page' => array(
				...
				'description' => sprintf( __( 'Selected page must contain "%s" element.', 'us' ), us_translate( 'Accordion', 'js_composer' ) ) . ' <a href="https://developers.google.com/search/docs/data-types/faqpage" target="_blank">' . __( 'Learn more', 'us' ) . '</a>',
				'type' => 'select',
				'options' => us_array_merge(
